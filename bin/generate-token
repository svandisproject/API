...
openssl genrsa -passout pass:$KEY_PASSWORD -out var/jwt/private.enc.pem -aes256 4096
openssl rsa -in var/jwt/private.enc.pem -passin pass:$KEY_PASSWORD -out var/jwt/private.pem
rm var/jwt/private.enc.pem
