...
class WorkerAuthenticator extends AbstractGuardAuthenticator
{
    private $workerUserProvider;

    public function __construct(WorkerUserProvider $workerUserProvider)
    {
        $this->workerUserProvider = $workerUserProvider;
    }
