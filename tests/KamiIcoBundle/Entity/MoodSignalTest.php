...
class MoodSignalTest extends ApiTestCase
{
    public function testIndexLoggedInAsAnonymous()
    {
        $response = $this->request('GET', '/api/mood-signal');
    ...
    {
        $response = $this->request('POST', '/api/mood-signal', [
            'mood_signal' => [
                'title' => 'test'
            ]
        ]);
    ...
    {
        $response = $this->requestByWorker('POST', '/api/mood-signal', [
            'mood_signal' => [
                'title' => 'test'
            ]
        ]);
    ...
    {
        $response = $this->request('PUT', '/api/mood-signal/1', [
            'mood_signal' => [
                'title' => 'test2'
            ]
        ]);
    ...
    {
        $response = $this->request('DELETE', '/api/mood-signal/1');
        $this->assertJsonResponse($response, 403);
    }
